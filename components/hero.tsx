     ...
     <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center min-h-screen px-6 md:px-10 lg:px-16 py-16">
        ...
        >
          ...
          <p className="text-lg text-foreground/80 leading-relaxed font-sans max-w-lg">
            3+ years crafting secure IT infrastructure, mastering penetration testing, and building resilient cybersecurity solutions. Specializing in vulnerability assessment and advanced threat analysis.
          </p>
          ...
          <div className="grid grid-cols-3 gap-8 pt-8">
            <div className="text-center space-y-2">
              <div className="text-3xl font-serif text-accent font-bold">3+</div>
